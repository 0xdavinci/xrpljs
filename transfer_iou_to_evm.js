...
async function transferXRPtoEVM() {
  try {
    ...
    const walletAAddress = "r4xiVkykqVcKFVL4Q69u2HRYLNHZPBUosF"; // Replace with Wallet A's XRPL Testnet address
    ...
    const wallet = Wallet.fromSeed("sEdSiDxAsKsAQVByUQ2JhMoECVxkrjz"); // Replace with Wallet A's XRPL Testnet seed
